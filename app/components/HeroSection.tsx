...
const HeroSection = () => {
  return (
    <div className=' h-[800px]  flex-col-reverse justify-between items-center p-[120px] '>
     ...
     <div className=" flex justify-center space-x-4 items-end text- p-2 h-[50px]  w-[500px] ">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
     ...
     <Button className="h-full w-fit font-bold      p-6 bg-secondary text-secondary-foreground hover:bg-secondary-foreground hover:text-white justify-between items-center text-xl"> Learn More</Button>
     </div> 
     </div>
